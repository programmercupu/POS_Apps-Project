        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Top Supplier by Transaksi</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <table class="table align-items-center mb-0">
                  ...
                  <?php
                    ...
                    $hasill ="SELECT * FROM supplier WHERE transaksi > 5 LIMIT $start, $limit";			
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $r['alamat']; ?></p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $r['nohp']; ?></p>
                      </td>
                      <td>
                        <p class="badge badge-sm bg-gradient-success"><?php echo $r['transaksi']; ?></p>
                      </td>                  
                    </tr>
                    <?php } ?> 
                  </tbody>
                ...
                <ul class="pagination justify-content-center" > 
                    <?php
                    $result = mysqli_query($mysqli, "SELECT COUNT(*) AS totals FROM supplier WHERE transaksi > 10 LIMIT $start, $limit");
