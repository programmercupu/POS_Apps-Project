              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <?php
                    ...
                    $hasill =" SELECT * FROM supplier LIMIT $start, $limit";			
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-3 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $r['nm_supp']; ?></h6>
                            <p class="text-xs text-secondary mb-0"><?php echo $r['kd_supplier']; ?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $r['email']; ?></p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $r['website']; ?></p>
                      </td>
                      ...
                      <td class="align-middle text-center">
                      <?php
                      echo "<a href='../system/Editsupp.php?id_brg=$r[kd_supplier]' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>
                          Upd
                        </a>"?>
                         /
                         <?php
                      echo "<a onclick='return konfirmasi()' href='../system/Deletesupp.php?id_brg=$r[kd_supplier]' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>
                          Del
                        </a>"?>
                      </td>
                    </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalAddLabel">Tambah Supplier Baru</h5>
      </div>
      <div class="modal-body">  
        <form method="post" action="../system/addsupplier.php">
        <?php   
                $qupdate = "SELECT max(id_supplier) as maxKode FROM supplier";
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group" hidden>
                ...
                <input type="text"  class="form-control" id="id_supplier" name="id_supplier" value="<?php echo "$no_urut"; ?>">
              </div>
              <div class="form-group">
                <label for="kd_supplier">Kode supplier</label>
                <input type="text"  class="form-control" readonly id="kd_supplier" name="kd_supplier" value="<?php echo "$newID"; ?>">
              </div>
              <div class="form-group">
                <label for="Nama">Nama</label>
                <input type="text" class="form-control" id="nm_supp" name="nm_supp">
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="trans" readonly values="0" name="trans">
              </div>
              <div class="form-group">
                <label for="transaksi">Official Web</label>
